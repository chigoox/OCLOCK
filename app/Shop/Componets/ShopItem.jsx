...
function ShopItem({ shopItems, location = 'HotTools', onShopPage }) {
    ...
    return (
        <Link href={`/Shop/${location}/${name.replace(/\s/g, '')}`} className='h-[20rem] fadeInZoomx2 flex-shrink-0  w-[11rem] md:h-[33rem]  md:w-[20rem]  my-2 shadow-sm shadow-black-800  border border-[#474747]  relative  rounded-lg overflow-hidden'>
